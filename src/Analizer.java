...
public class Analizer {
    ...
    private final Set<String> dictionarySet = new HashSet<>();
    ...
    // конструктор на случай если мы хотим проверить файл на количество по умолчанию (1) совпадений со словарем
    ...
    // конструктор на случай если мы хотим проверить файл на совпадения по своему словарю
    public Analizer(String inputFile, String dictionary) {
    ...
    private void fillDictionary(String dictionary) {
        this.dictionary = dictionary;
        fillDictionary();
    }
